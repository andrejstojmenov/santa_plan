...
{
	require('includes/validation/val_vnesi_korisnik.php');
	...
	if(!isset($validation_errors)) // podatocite se dobri, unesi u baza
	{
			...
			$insertQuery = "
				INSERT INTO firmi (username, password, firma_ime, firma_edb, firma_tel, role_id)
				VALUES ('{$user_data['username']}', '{$user_data['password']}', '{$user_data['firma_ime']}', {$user_data['firma_edb']}, '{$user_data['firma_tel']}', 2)
			";
			...
			if (!mysqli_query($db, $insertQuery)) {
				...
				$_SESSION['success_message'] = 'Корисникот е успешно внесен';
			}
			...
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">                    
				<div class="panel panel-info" >
						<div class="panel-heading">
							<div class="panel-title">Внеси нов корисник</div>
						</div>     
						...
						<div style="padding-top:30px" class="panel-body" >
							...
							<form action="vnesi_korisnik.php" method="post" id="loginform" class="form-horizontal" role="form">
								...
								<div style="margin-top:10px" class="form-group">
									<div class="col-sm-12 controls">
										<input type="submit" name="submit" class="btn btn-success" value="Внеси" />
									</div>
								</div>  
							</form>     
						</div>                     
